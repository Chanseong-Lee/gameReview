					...
					<div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                            	...
                            	<form:form action="specReg" commandName="gameSpecCommand" method="post"	enctype="multipart/form-data">
                                <table class="table table-bordered" id="dataTable" width="80%" cellspacing="0">
                                    <tbody>
										...
										<tr>
											...
											<td><input type="file" name="slideImgFile" placeholder="파일 선택" accept="image/jpeg, image/png ,image/gif"
								...
								<input id="submit" type="submit" value="등록완료" style="display: none;">&nbsp;&nbsp;
