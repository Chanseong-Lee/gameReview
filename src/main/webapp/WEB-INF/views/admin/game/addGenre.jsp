                ...
                <div class="container-fluid">
					...
					<div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">장르 추가</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                            	<div class="form-group">
                            	<form:form action="addGenre" commandName="addGenre" method="post" enctype="multipart/form-data">
                                <table class="table table-bordered" id="dataTable" width="80%" cellspacing="0">
                                    <tbody>
										<tr>
											<td colspan="2">
												<c:forEach var="genre" items="${genreList}">
													<li><c:out value="${genre.genName}"></c:out></li>
												</c:forEach>
											</td>
										</tr>
								...
								<label for="submit" class="btn btn-success btn-icon-split">
                                        ...
                                        <span class="text">추가 완료</span>
                                </label>
								<input id="submit" type="submit" value="수정완료" style="display: none;">&nbsp;&nbsp;
								<label onclick="location.href='<c:url value="/admin/game/delGenre"/>'" class="btn btn-danger btn-icon-split">
                                    <span class="icon text-white-50">
