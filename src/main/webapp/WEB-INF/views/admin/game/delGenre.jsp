					...
					<div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                            	...
                            	<form:form action="delGenre" commandName="delGenre" method="post" enctype="multipart/form-data">
                                <table class="table table-bordered" id="dataTable" width="80%" cellspacing="0">
                                    <tbody>
										<tr>
											<td>
												<c:forEach var="genre" items="${genreList}">
													<li><input type=checkbox name="genNum" value="${genre.genNum}">
														 <c:out value="${genre.genName}" /></li>
												</c:forEach>
											</td>
										</tr>
							      	</tbody>
								</table>
								<label for="submit" class="btn btn-danger btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-trash"></i>
                                        </span>
                                        <span class="text">삭제 완료</span>
                                </label>
								<input id="submit" type="submit" value="수정완료" style="display: none;">&nbsp;&nbsp;
								
								<label onclick="location.href='<c:url value="/admin/game/addGenre"/>'" class="btn btn-secondary btn-icon-split">
                                    <span class="icon text-white-50">
