					...
					<div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                            	...
                            	<form:form action="${pageContext.request.contextPath }/admin/game/genreModify/${game.gNum}" commandName="modifyGenre" method="post">
								<form:input type="hidden" value="${game.gNum}" path="gNum" />
                                <table class="table table-bordered" id="dataTable" width="80%" cellspacing="0">
                                    <tbody>
										<tr>
											<th class="text-center" colspan="2">장르 수정</th>
										</tr>
										<tr>
											<th>기존 장르</th>
											<th>새로운 장르를 선택하세요</th>
										...
										<tr>
											<td><c:forEach var="genre" items="${genresOfGame}">
											...
											<td>
												<ol>
													<c:forEach var="genre1" items="${AllGenres}">
														<c:set var="checked" value="" />
														<c:forEach var="genreList" items="${genresOfGame }">
																<c:if test="${genre1.genNum == genreList.genNum}">
																	<c:set var="checked" value="checked" />
																</c:if>
														</c:forEach>
														<li>
															<input type=checkbox name="genNum" value="${genre1.genNum}" ${checked }>
															<c:out value="${genre1.genName}" />
														</li>
													</c:forEach>
												</ol>
											</td>
