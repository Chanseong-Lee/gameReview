					...
					<div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                            	...
                            	<form:form action="${pageContext.request.contextPath }/admin/game/gameModify/${game.gNum}" commandName="modifyGame" method="post">
                                ...
                                <table class="table table-bordered" id="dataTable" width="80%" cellspacing="0">
                                    <tbody>
										<tr>
											<td>게임 이름</td>
											<td>
												<form:input class="form-control" path="gName" value="${game.gName}" />
										...
										<tr>
											<td>게임코드</td>
											<td>
												<c:out value="${game.gCode }"></c:out>
												<input type="hidden" name="gCode" value="${game.gCode }">
											</td>
										</tr>
										<tr>
											<td>개발사</td>
											<td>
												<form:input class="form-control" path="gDev" value="${game.gDev}" />
										...
										<tr>
											<td>출시일</td>
											<td>
												<fmt:formatDate value="${game.gDate }" pattern="yyyy-MM-dd" var="releaseDate" /> 
												<form:input class="form-control" type="date"	path="gDate" value="${releaseDate }" />
										...
										<tr>
											...
											<td>
												<form:input class="form-control" path="gPrice" pattern="[0-9]+" value="${game.gPrice}" />
										...
										<tr>
											<td>게임 소개</td>
											<td colspan="1">
												<textarea class="form-control" name="gContent" rows="10" cols="45">${game.gContent}</textarea>
											</td>
											<form:errors path="gContent"/>
										</tr>
							      	</tbody>
								</table>
								...
								<label onclick="location.href='<c:url value="/admin/game/gameDetail/${game.gNum }"/>'" class="btn btn-secondary btn-icon-split">
                                    <span class="icon text-white-50">
