					...
					<div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/item/itemUpdate/${item.itemNum }" class="btn btn-info btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-info-circle"></i>
                                        </span>
                                        <span class="text">수정하기</span>
                                </a>
								<a href="javascript:deleteItem()" class="btn btn-danger btn-icon-split">
	                            	<span class="icon text-white-50">
	                                	<i class="fas fa-trash"></i>
	                                </span>
	                                <span class="text">삭제하기</span>
                                </a>
                                <a href="${pageContext.request.contextPath}/admin/item/itemList" class="btn btn-secondary btn-icon-split">
                                    <span class="icon text-white-50">
   ...
   <!-- Bootstrap core JavaScript-->
	...
	<script>
		function deleteItem(){
			...
			if(flag){
				location.href='${pageContext.request.contextPath}/admin/item/itemDelete/${item.itemNum }';
			}
		}
	</script>
</body>
