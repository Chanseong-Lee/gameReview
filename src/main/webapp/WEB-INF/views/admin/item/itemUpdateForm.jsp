                                    ...
                                    <tbody>
										<tr>
											...
											<c:if test="${item.itemNum == 1 }">
												<img id="thumbnailImg" src="<c:url value='/resources/images/user_icon/${item.itemFilename}'/>" width="15px">
											</c:if>
											<c:if test="${item.itemNum == 6 }">
												<img id="thumbnailImg" src="<c:url value='/resources/images/user_icon/${item.itemFilename}'/>" width="15px">
											</c:if>
											<c:if test="${item.itemNum != 1 && item.itemNum != 6}">
												<img id="thumbnailImg" src="<c:url value='/images/icons/${item.itemFilename}'/>" width="15px">
											</c:if>
											</td>
										</tr>
										<tr>
