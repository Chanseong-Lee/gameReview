                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <tbody>
										<tr>
											<td colspan="2">
												<div id="prifileImgBox" style="text-align: center;">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/member/memberUpdate/${member.mNum }" class="btn btn-info btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-info-circle"></i>
                                        </span>
                                        <span class="text">수정하기</span>
                                </a>
								<a href="javascript:deleteMember()" class="btn btn-danger btn-icon-split">
	                            	<span class="icon text-white-50">
	                                	<i class="fas fa-trash"></i>
	                                </span>
	                                <span class="text">강제 탈퇴</span>
                                </a>
                                <a href="${pageContext.request.contextPath}/admin/member/memberList" class="btn btn-secondary btn-icon-split">
                                    <span class="icon text-white-50">
