...
<form action="${pageContext.request.contextPath}/member/login" method="POST" onsubmit="return loginSubmit()">
	...
	<label><input type="checkbox" id="remember-me" name="remember-me"/>자동 로그인</label><br>
...
<a href="${pageContext.request.contextPath}/findId">아이디</a> / <a href="${pageContext.request.contextPath}/findPwd">비밀번호</a>가 기억이 나지 않으시나요?
