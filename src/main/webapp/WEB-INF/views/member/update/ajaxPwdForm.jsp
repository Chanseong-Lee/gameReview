...
<table class="table">
	...
	<tr>
		<td>비밀번호</td>
		<td>
			<input class="form-control-sm" type="password" id="password" name="password" placeholder="새 비밀번호 입력"><br>
	...
	<tr>
		<td>비밀번호 확인</td>
		<td>
			<input class="form-control-sm" type="password" id="confirmPassword" name="confirmPassword" placeholder="비밀번호 확인"><br>
...
<button class="btn btn-success btn-sm" type="button" id="submit" onclick="updatePwdBtn()">변경사항 저장</button>
